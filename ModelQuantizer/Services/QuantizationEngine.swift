...
public struct GGUFParser {
    ...
    private mutating func readMetadataArrayElement(type: UInt32) throws -> GGUFBuilder.MetadataValue {
        ...
        case 2: return .uint16(readData(count: 2).withUnsafeBytes { $0.load(as: UInt16.self) })
        case 3: return .int16(readData(count: 2).withUnsafeBytes { $0.load(as: Int16.self) })
        case 4: return .uint32(readUInt32())
        case 5: return .int32(Int32(bitPattern: readUInt32()))
        case 6: return .float32(readData(count: 4).withUnsafeBytes { $0.load(as: Float.self) })
        ...
        case 12: return .float64(readData(count: 8).withUnsafeBytes { $0.load(as: Double.self) })
        default:
            throw QuantizationError.invalidModelFormat
        }
    }
